"""
Note: this is downloaded from https://github.com/bzamecnik/midi2audio.
It is not installed as a library, since the "pip install" provides an
old version, without a feature we require.
"""
